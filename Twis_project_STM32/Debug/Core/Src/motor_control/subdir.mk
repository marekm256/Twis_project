...
Core/Src/motor_control/%.o Core/Src/motor_control/%.su Core/Src/motor_control/%.cyclo: ../Core/Src/motor_control/%.c Core/Src/motor_control/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DDEBUG -DUSE_HAL_DRIVER -DSTM32F303x8 -c -I../Core/Inc -I../Core/Src/comm -I../Core/Src/motor_control -I../Core/Src/ultrasonic -I../Core/Src/imu_mpu6500 -I../Drivers/STM32F3xx_HAL_Driver/Inc/Legacy -I../Drivers/STM32F3xx_HAL_Driver/Inc -I../Drivers/CMSIS/Device/ST/STM32F3xx/Include -I../Drivers/CMSIS/Include -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"

clean: clean-Core-2f-Src-2f-motor_control

clean-Core-2f-Src-2f-motor_control:
	-$(RM) ./Core/Src/motor_control/motor_control.cyclo ./Core/Src/motor_control/motor_control.d ./Core/Src/motor_control/motor_control.o ./Core/Src/motor_control/motor_control.su
