...
class App(tk.Tk):
    ...
    def _build_ui(self):
        ...
        r = 0
        self._kv(grid, r, "Dist:", self.dist); r += 1
        self._kv(grid, r, "Ax:", self.ax); r += 1
        self._kv(grid, r, "Ay:", self.ay); r += 1
        self._kv(grid, r, "Az:", self.az); r += 1
        self._kv(grid, r, "Gx:", self.gx); r += 1
        self._kv(grid, r, "Gy:", self.gy); r += 1
        self._kv(grid, r, "Gz:", self.gz); r += 1
        self._kv(grid, r, "Temp:", self.temp); r += 1
